// Meta Pixel Analytics — reads event data from Facebook Graph API
// GET /.netlify/functions/meta-pixel-analytics?range=7d|30d|90d
// Env vars required:
//   FB_ACCESS_TOKEN  — long-lived user or system user token with ads_read permission
//   FB_PIXEL_ID      — optional override; defaults to 711956342472188
...
const PIXEL_ID = process.env.FB_PIXEL_ID || '711956342472188';
...
exports.handler = async (event) => {
  ...
  try {
    ...
    // Fetch pixel event stats and pixel info in parallel
    ...
    // Build daily chart — aggregate by day
    const dailyMap = {};
    for (const row of (statsData.data || [])) {
