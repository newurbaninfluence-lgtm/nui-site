...
<button onclick="showClientHistoryImport()" style="padding: 10px 16px; background: #7c3aed; color: #fff; border: none; border-radius: 8px; cursor: pointer; font-weight: 600; font-family: inherit;">📥 Import History</button>
</div>
