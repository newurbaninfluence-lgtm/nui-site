...
<a onclick="showAdminPanel('leads')" class="admin-nav-link" data-panel="leads"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>Submissions</a>
...
<a onclick="showAdminPanel('visitors')" class="admin-nav-link" data-panel="visitors"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>Visitors</a>
</div>
<div class="admin-nav-group">
...
<a onclick="showAdminPanel('agents')" class="admin-nav-link" data-panel="agents"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/><circle cx="12" cy="16" r="1"/></svg>AI Agents</a>
<a onclick="showAdminPanel('monty')" class="admin-nav-link" data-panel="monty"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2a3 3 0 0 0-3 3v1H6a2 2 0 0 0-2 2v2a6 6 0 0 0 4.5 5.8V18a3 3 0 0 0 3 3h1a3 3 0 0 0 3-3v-2.2A6 6 0 0 0 20 10V8a2 2 0 0 0-2-2h-3V5a3 3 0 0 0-3-3z"/><circle cx="9" cy="10" r="1"/><circle cx="15" cy="10" r="1"/></svg>Monty AI</a>
<a onclick="showAdminPanel('sites')" class="admin-nav-link" data-panel="sites"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>Client Sites</a>
<a onclick="showAdminPanel('datahealth')" class="admin-nav-link" data-panel="datahealth"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg>Account Linkage</a>
<a onclick="showAdminPanel('subaccounts')" class="admin-nav-link" data-panel="subaccounts"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 7V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2"/><line x1="12" y1="12" x2="12" y2="16"/><line x1="10" y1="14" x2="14" y2="14"/></svg>Sub-Accounts</a>
...
<div id="adminAgentsPanel" class="admin-panel"></div>
...
<div id="adminMontyPanel" class="admin-panel"></div>
<div id="adminSubscriptionsPanel" class="admin-panel"></div>
<div id="adminSitesPanel" class="admin-panel"></div>
<div id="adminDatahealthPanel" class="admin-panel"></div>
<div id="adminSubaccountsPanel" class="admin-panel"></div>
<div id="adminVisitorsPanel" class="admin-panel"></div>
</main>
</div>
</div>
