...
It's a long game. Faren Young has been playing it since 2007. He's not stopping.`,
    ...
    // ── ARTICLE 4: Built Heavy — Faren Young Author Feature
    {
      ...
      podcastUrl: '/assets/audio/built-heavy-podcast.m4a',
      authorMode: true,
...
New Urban Influence is proud to feature Keith Jackson and Deep Drama Design Lab as a member of the NUI Creator Network.`,
    ...
    // ── ARTICLE 7: Ashley Mathaw — Backyard Comedy Battle ─────────────
    {
      ...
      title: 'Ashley Mathaw Is Not Your Average Comedian — She Built the Whole Show',
      dek: 'Detroit\'s own Ashley Mathaw went from West Side kid to Los Angeles stage to self-producing Backyard Comedy Battle — one of the most interactive comedy experiences in the game right now.',
      category: 'creators', categoryLabel: 'Comedian & Creator · Detroit',
      author: 'NUI Editorial', publishedAt: '2026-04-06', readTime: '5 min read',
      featured: true, premium: false, award: null,
      heroImage: '/images/magazine/ashley-mathaw-event.jpg',
      profileImage: '/images/magazine/ashley-mathaw-profile.jpg',
      profileBio: 'Detroit-born stand-up comedian, actor, content creator, and day trader. Creator and producer of Backyard Comedy Battle. Known on stage and online as "Young Tender."',
      ownerBio: {
        label: 'Comedian, Actor & Creator — Backyard Comedy Battle',
        headline: 'The Block Produced Her. The Stage Couldn\'t Hold Her Back.',
        body: 'Ashley Mathaw grew up on the West Side of Detroit watching comedy legends and dreaming of the stage despite crippling stage fright. She moved to Los Angeles, started from scratch, and built Backyard Comedy Battle — a self-produced interactive show that\'s unlike anything else on the circuit. She\'s not just performing comedy. She\'s running the whole operation.',
        stats: [{ val: 'Detroit', label: 'West Side Raised' },{ val: 'LA', label: 'Based & Building' },{ val: '7.9K', label: 'Instagram Followers' },{ val: 'BCB', label: 'Backyard Comedy Battle' }],
        tags: ['Stand-Up Comedy', 'Content Creator', 'Detroit', 'Backyard Comedy Battle', 'Day Trader'],
      },
      tags: ['Detroit', 'Comedy', 'Stand-Up', 'Creator', 'Backyard Comedy Battle', 'Ashley Mathaw', 'Los Angeles'],
      body: `Some people perform comedy. Ashley Mathaw builds it — from the ground up, on her own terms, in rooms she created herself.

The Detroit-born comedian, actor, and content creator has spent years doing what most people only talk about: she started. Started stand-up despite stage fright. Started a new life in Los Angeles despite the cost. Started her own show when the industry wasn't ready to give her one.

## West Side Roots

Ashley Mathaw grew up on Detroit's West Side, surrounded by family, raised in a city that gets a bad rep but gave her something invaluable — a grounded sense of who she is and where she comes from. It was there, as a kid who rarely watched TV, that she caught a Martin Lawrence special and felt her entire world shift.

The way he told stories. The act-outs. The timing. The raw humanity of it. She didn't just laugh — she wanted to do it herself. That spark sat with her through her teen years, through her 20s, through mail carrier routes and college classes and every moment of ordinary life before the extraordinary became possible.

## From Stage Fright to the Stage

When Ashley finally stepped into Detroit comedy clubs at 21, the decision crystallized. Watching heavyweights like Coolaide, Mic Larry, Darius Bennett, and Josh Adams up close, she made a choice: she was going to try her hand at this.

She started. That's the word she uses when she talks about what makes her proud. Not winning. Not blowing up. Starting — despite the fear, despite the uncertainty, despite everything that makes staying comfortable seem more reasonable.

She started stand-up. Started acting classes. Started improv. Started content creation. Left Detroit for Los Angeles, where the cost of living hit her like a wall and the grind reset itself. She was making good money back home, had a nice place outside the city, a solid car, and what felt like the good life. California demanded something else. She gave it.

## Backyard Comedy Battle: Her Show, Her Rules

The crown jewel of Ashley Mathaw's creative career is Backyard Comedy Battle — a self-produced interactive comedy show she built from scratch. This isn't a showcase. It's not an open mic in disguise. BCB is an experience — one she designed, promotes, and runs herself.

In her own words: *"It's not just a regular comedy show."*

That's the point. BCB lives at the intersection of comedy, crowd energy, and real-time connection. It's the kind of show where the audience doesn't just watch — they're part of what makes it work. The laughter is louder, the moments are more unpredictable, and the energy is something you can only get when someone who genuinely loves this craft is running the room.

## Built for What's Next

Outside of comedy, Ashley is a serious options and futures day trader — a discipline she threw herself into in California when she knew she needed a way to stop trading time for dollars. She lost money, had accounts go negative, kept going. The discipline she built in trading mirrors the discipline she brings to comedy: obsessive, consistent, not remotely interested in quitting.

More projects are coming. More shows. She says "WE" when she talks about it — because she understands that a show lives and dies on the energy of the people who show up for it.

New Urban Influence is proud to feature Ashley Mathaw as a member of the NUI Creator Network — a Detroit original who didn't wait for a seat at the table. She built the whole room.`,
      business: {
        name: 'Ashley Mathaw — Backyard Comedy Battle', category: 'Stand-Up Comedian & Show Creator',
        phone: '', address: 'Los Angeles', city: 'Los Angeles', state: 'CA', zip: '',
        website: '', email: 'amathaw1@gmail.com', instagram: '@young10der',
        rating: 5.0, reviewCount: 0, citationId: 'NUI-DET-2026-0006',
        verifiedDate: 'April 2026', verifiedUrl: 'https://www.instagram.com/young10der/',
        sameAs: ['Instagram', 'Facebook', 'LinkedIn'],
        services: ['Stand-Up Comedy','Backyard Comedy Battle (Live Show)','Acting','Content Creation','Interactive Comedy Events'],
      },
      reviews: [],
    },
  ],
