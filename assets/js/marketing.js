...
let aboutData = JSON.parse(localStorage.getItem('nui_about')) || {
    ...
    team: [
        { name: 'Faren Young', title: 'Creative Director & Founder', bio: 'Martez Hand — widely known as the creative Faren Young — is a native Detroiter with 20+ years guiding businesses to success through bold design and strategic branding. From Bravo Graphix on the Avenue of Fashion to New Urban Influence, he builds empires.', photo: 'https://res.cloudinary.com/dlc1yycrq/image/upload/w_400,h_400,c_fill,g_face/v1774844380/team-faren-young.png' },
        { name: 'AJ Grant', title: 'Lead Photographer & Visual Partner', bio: 'AJ Grant is the lens behind Detroit\'s most iconic moments. With 36K followers and 229 Google reviews, AJ Photography Studio has been NUI\'s trusted visual partner — capturing the brands we build in their fullest light.', photo: 'https://res.cloudinary.com/dlc1yycrq/image/upload/w_400,h_400,c_fill,g_face/v1774844382/team-aj-grant.jpg' },
        ...
        { name: 'Monty Young', title: 'AI Brand Assistant', bio: 'Monty is NUI\'s custom-built AI assistant — trained on brand strategy, client history, and Detroit culture. Available 24/7, Monty handles inquiries, guides prospects, and keeps the brand engine running around the clock.', photo: 'https://res.cloudinary.com/dlc1yycrq/image/upload/w_400,h_400,c_fill/v1774844384/team-monty-ai.png' }
    ]
};
function saveAbout() {
