  ...
  <div style="max-width:1200px;margin:0 auto;padding:64px 48px 40px;display:grid;grid-template-columns:2fr 1fr 1fr 1fr;gap:48px;">
    ...
    <div>
      ...
      <div style="display:flex;flex-direction:column;gap:10px;">
        ...
        <a href="/services/social-media-management-detroit" style="font-size:13px;color:rgba(255,255,255,0.4);text-decoration:none;transition:color .2s;" onmouseover="this.style.color='#D90429'" onmouseout="this.style.color='rgba(255,255,255,0.4)'">Digital Promotion Team</a>
